...
describe("AllModelsPanel", () => {
  ...
  it("clears model_group together with every table key in one URL update from Reset Filters", async () => {
    ...
    const { onUrlUpdate } = renderPanel(
      "?model_group=gpt-4&model_search=claude&page=2&page_size=25&sort_by=model_name&sort_order=desc&filter_team=team-1&filter_access_group=sales-team&view=all",
    );
